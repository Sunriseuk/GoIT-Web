...
#функция получает пароль, хеширует его и сравнивает с хешем в базе
...
#Получает данные и создает токен, который живет 15 минут, если время его существования не указано
