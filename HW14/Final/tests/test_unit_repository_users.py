...
users = [
    ...
    phone = "0987654321", birthaday = date(year=1988, month=3, day=28), description = "Some info for testing",
    authuser_id = 1),
    User(
    first_name = "User1", second_name = "Example1", email = "example1@gmail.com",
    phone = "0987654321", birthaday = date(year=1988, month=3, day=24), description = "Some info for testing",
    authuser_id = 1),
    User(first_name = "User2", second_name = "Example2", email = "example2@gmail.com",
    phone = "0987654321", birthaday = date(year=1988, month=3, day=22), description = "Some info for testing",
    authuser_id = 1)
    ]
