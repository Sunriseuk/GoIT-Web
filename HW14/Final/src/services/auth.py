...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param hashed_password: Check the password that is being entered by the user
    ...
    async def create_access_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass the data that is to be encoded in the access token
    ...
    async def decode_refresh_token(self, refresh_token: str):
        ...
        :return: The email address of the user who owns the refresh token
        :doc-author: Trelent
        """
        try:
