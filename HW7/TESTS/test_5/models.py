...
# Таблица notes, где будут храниться названия заданий
class Note(Base):
    __tablename__ = "notes"
...
# Таблица records, где будут храниться записи дел для конкретного задания из таблицы notes - связь one-to-many, поле note_id
class Record(Base):
